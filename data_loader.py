...
def create_dataloaders(train_dataset_path, val_dataset_path, batch_size, num_workers, train_size=None, val_size=None, train_seg_path=None, val_seg_path=None):
    ...
    if train_seg_path is not None and val_seg_path is not None:
        train_transform = SegmentationPairTransform(image_size=256, train=True)
        val_transform = SegmentationPairTransform(image_size=256, train=False)
